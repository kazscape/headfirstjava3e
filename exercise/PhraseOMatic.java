public class PhraseOMatic {
  public static void main (String[] args) {
    ...
    String[] wordListTwo = {"loosely coupled", "six sigma", "asumchronous", "event driven", "pub-sub", "IoT", "cloud native", "service oriented", "containerized", "serverless", "microservices", "distributed ledger"};
